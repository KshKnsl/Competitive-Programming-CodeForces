    ...
    public static void main(String[] args) 
    {
        ...
        while (t-- > 0) 
        {
            ...
            while(s.contains("01") || s.contains("10")) 
            {
                ...
                if(s.indexOf("01") != -1) s = s.substring(0, s.indexOf("01")) + s.substring(s.indexOf("01") + 2);
                else s = s.substring(0, s.indexOf("10")) + s.substring(s.indexOf("10") + 2);                
                res = !res;
                // System.out.println(s+"\t"+res);
            }
            System.out.println((res==true)?"NET":"DA"); 
        }
        out.flush();
    }
}